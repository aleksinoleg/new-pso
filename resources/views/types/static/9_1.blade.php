...
$soap = \App\Page::where('lang',$L->lang)
        ->where('type','product')
        ->where('prod_id','1002')
        ->first();
        ...
        <div class="row">
            ...
            <div class="float_left basket_left_section">
                ...
                <form action="/proceed_order" method="post" id="proceed_order">
                                ...
                                <div class="flex">
                                    <div class="margin_auto">
                                        ...
                                        @if(session()->has('free_soap')&&$item['prod_id']==1002&&$item['price']==0)
                                                {{sprintf("%01.2f",0)}}
                                            @else
                                                {{sprintf("%01.2f",$item['product']->price->price)}}
                                            @endif
                                    </span>
                                    </div>
                                </div>
                            ...
                            <div class="float_left cart_quantity_basket">
                                <div class="flex">
                                    <div class="margin_auto">
                                        ...
                                        @if(session()->has('free_soap')&&$item['prod_id']==1002) @else{!!$img->__('arrow_left_basket.png','arrow_left_basket','data-key='.$key)!!}@endif
                                        <input type="text" class="quantity_input" value="{{$item['quantity']}}"
                                               name="prod_id['{{$item['prod_id']}}']" readonly>
                                        @if(session()->has('free_soap')&&$item['prod_id']==1002) @else{!!$img->__('arrow_right_basket.png','arrow_right_basket','data-key='.$key)!!}@endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="cart_table_row free_soap_60_sec">
                        <div class="float_left cart_prod_name">
                            <div class="cart_prod_name_img float_left">
                                {!!$img->__('basket_soap_present.jpg')!!}
                            </div>
                            <div class="cart_prod_name_text float_left">
                                <div class="flex">
                                    <div class="margin_auto">
                            ...
                            <div class="flex">
                                <div class="margin_auto">
                                    ...
                                    <input type="text" class="quantity_input" value="1"
                                           name="prod_id['{{$soap->prod_id}}'_free]" readonly>
                        ...
                        <div class="float_left cart_subtotal">
                            <div class="flex">
                                <div class="margin_auto">
                                    <div class="float_left cart_subtotal cart_subtotal_mob">{{$L->__('SUBTOTAL')}}</div>
                                    {{$item['currency']}}.
                                    <span class="sub_total" data-id="{{substr($soap->prod_id,0,1)}}">
                                            {{sprintf("%01.2f",0)}}
                                        </span>
                                </div>
                            </div>
                        ...
                        <div class="float_left cart_dell">
                            <div class="flex">
                                <div class="margin_auto">
                                    <div class="dell_free_soap_60">
                                        {!!$img->__('delete.png', 'cart_dell_img')!!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <input class="free_soap_60_input" type="hidden" name="free_soap_60" value="0">
                </form>
...
@section('footer')
    <script>
        ...
        <?}elseif(session()->has('discount_api')){?>
            ...
            if (a > 60) {
                $('.free_soap_60_sec').show();
                $('.free_soap_60_input').val(1);
            }else{
                $('.free_soap_60_sec').hide();
                $('.free_soap_60_input').val(0);
            }
        ...
        $('.dell_free_soap_60').click(function () {
            $('.free_soap_60_sec').hide();
            $('.free_soap_60_input').val(0);
        });
