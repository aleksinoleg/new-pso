            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-7">
                <div class="login_form form">
                    ...
                    <form action="{{url('/admin/toMail')}}" method="post">
                        ...
                        <label for="text">{{$L->__('part_input_1')}}</label>
                        <div class="input in_name">
                            <input type="text" name="name" id="text" required>
                        </div>
                        <label for="email">{{$L->__('part_input_2')}}</label>
                        <div class="input in_email">
                            <input type="email" name="email" id="email" required>
                        </div>
                        <label for="tel">{{$L->__('part_input_3')}}</label>
                        <div class="input in_tel">
                            <input type="tel" name="tel" id="tel"  pattern="^[ 0-9\s\+\-]+$">
                        </div>
                        <label for="message">{{$L->__('part_input_4')}}</label>
                        <div class="input in_text">
                            <textarea name="message" id="message" required></textarea>
                         </div>
                        <div style="padding-left: 40px"><input type="submit" name="send" value="{{$L->__('part_input_5')}}"></div>
                    </form>
                </div>
            </div>
