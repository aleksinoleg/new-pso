            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-7">
                <div class="login_form form">
                    ...
                    <form action="{{url('/admin/contact-us')}}" method="post">
                        ...
                        <label for="text">{{$L->__('First name')}}</label>
                        <div class="input in_name">
                            <input type="text" name="name" id="text" required>
                        </div>
                        <label for="email">{{$L->__('Email address')}}</label>
                        <div class="input in_email">
                            <input type="email" name="email" id="email" required>
                        </div>
                        <label for="tel">{{$L->__('Telephone Number')}}</label>
                        <div class="input in_tel">
                            <input type="tel" name="tel" id="tel"  pattern="^[ 0-9\s\+\-]+$">
                        </div>
                        <label for="message">{{$L->__('How can we help?')}}</label>
                        <div class="input in_text">
                            <textarea name="message" id="message" required></textarea>
                         </div>
                        <div style="padding-left: 40px"><input type="submit" name="send" value="{{$L->__('Send email')}}"></div>
                    </form>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
                <div class="phones">
                    ...
                    <div class="contact__address">
                        <p>{{$L->__('Contact_address')}}</p>
                        <p class="contact__paragraph">{{$L->__('Contact_address_1')}}</p>
                        <p class="contact__paragraph">{{$L->__('Contact_address_2')}}</p>
                        <p class="contact__paragraph">{{$L->__('Contact_address_3')}}</p>
                    </div>
                </div>
            </div>
